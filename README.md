...
Simply unzip the folder iMessageDeleteCaches.zip to your Desktop, double click the iMessageDeleteCaches.command and then follow the on screen instructions.
